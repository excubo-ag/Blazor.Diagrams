...
namespace Excubo.Blazor.Diagrams
{
    internal static class JSRuntimeExtensions
    {
        ...
        {
            return js.InvokeVoidAsync("eval", "window.Excubo=window.Excubo||{};window.Excubo.Diagrams=window.Excubo.Diagrams||{position:n=>({Left:n.offsetLeft,Top:n.offsetTop}),size:n=>({Width:n.clientWidth,Height:n.clientHeight}),ro:new ResizeObserver(n=>{for(const t of n){let i=Array.from(new Set(t.target.attributes)).find(n=>n.name.startsWith('_bl_')).name,n=window.Excubo.Diagrams.references[i];n!=undefined&&n.Ref.invokeMethodAsync('OnResize',{Width:t.contentRect.width,Height:t.contentRect.height}).catch(()=>{})}}),mo:new MutationObserver(()=>{for(const t in window.Excubo.Diagrams.references){var n=window.Excubo.Diagrams.references[t];if(n!=undefined){const t=n.Element.offsetLeft,i=n.Element.offsetTop,r=n.Element.clientWidth,u=n.Element.clientHeight;(n.Left!=t||n.Top!=i||n.Width!=r||n.Height!=u)&&(n.Left=t,n.Top=i,n.Width=r,n.Height=u,n.Ref.invokeMethodAsync('OnMove',{Left:t,Top:i,Width:r,Height:u}).catch(()=>{}))}}}),references:{},observeResizes:(n,t,i)=>{const r=window.Excubo.Diagrams;r.references[t]={Element:n,Ref:i,Left:n.offsetLeft,Top:n.offsetTop,Width:n.clientWidth,Height:n.clientHeight};r.ro.observe(n)},unobserveResizes:(n,t)=>{const i=window.Excubo.Diagrams;delete i.references[t];i.ro.unobserve(n)},observeMoves:(n,t,i)=>{const r=window.Excubo.Diagrams;for(r.references[t]={Element:n,Ref:i,Left:n.offsetLeft,Top:n.offsetTop,Width:n.clientWidth,Height:n.clientHeight};n.parentElement!=null;)r.mo.observe(n.parentElement,{attributes:!0}),n=n.parentElement},unobserveMoves:(n,t)=>{const i=window.Excubo.Diagrams;for(delete i.references[t];n.parentElement!=null;)i.mo.unobserve(n.parentElement),n=n.parentElement}};");
        }
