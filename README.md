...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.Diagrams -Version 1.6.0
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.Diagrams --version 1.6.0
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.Diagrams" Version="1.6.0" />
```
